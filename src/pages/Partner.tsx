  ...
  const benefits = [
    {
      ...
      description: "Получайте до 30% от каждой оплаты привлеченного пользователя",
    },
    {
      icon: Users,
      title: "Пожизненные выплаты",
      description: "Зарабатывайте с каждого продления подписки ваших рефералов",
    },
    {
      icon: TrendingUp,

  ...
  const faqs = [
    {
      ...
      answer: "Зарегистрируйтесь на платформе, выберите интересующую вас категорию и репетитора. Начните с бесплатного плана или выберите подходящую подписку.",
    },
    {
      question: "Что входит в подписку",
      answer: "Подписка открывает полный доступ ко всей платформе:\n— Все репетиторы без ограничений\n— Все темы и направления обучения\n— Отслеживание личного прогресса\n— Ежедневный стрик (серия занятий без пропусков)",
    },
    {
      question: "Как работает бесплатный план?",
      answer: "Бесплатный план дает доступ к 1 репетитору и 5 минутам обучения в день. Этого достаточно для знакомства с платформой.",
    },
    {
      question: "Можно ли отменить подписку?",
      answer: "Да, вы можете отменить подписку в любой момент через личный кабинет. Доступ сохранится до конца оплаченного периода.",
    },
  ];
